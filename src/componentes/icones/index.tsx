...
export const IconeBloquear: React.FC<PropriedadesIcone> = ({ tamanho = 24, cor = 'currentColor', classe = '' }) => (
  <svg width={tamanho} height={tamanho} viewBox="0 0 24 24" fill="none" stroke={cor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={classe}>
    <circle cx="12" cy="12" r="10" />
...
export const IconeDesbloquear: React.FC<PropriedadesIcone> = ({ tamanho = 24, cor = 'currentColor', classe = '' }) => (
  <svg width={tamanho} height={tamanho} viewBox="0 0 24 24" fill="none" stroke={cor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={classe}>
    <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
...
export const IconePdf: React.FC<PropriedadesIcone> = ({ tamanho = 24, cor = 'currentColor', classe = '' }) => (
  <svg width={tamanho} height={tamanho} viewBox="0 0 24 24" fill="none" stroke={cor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={classe}>
